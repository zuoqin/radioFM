package onn.android.hpuser.rad100fm.helpers;
...
public class Downloader {
    ...
    private static String myTag = "downloaderLog";
    ...
    public static void DownloadFromUrl(String URL, FileOutputStream fos) {  //this is the downloader method
        try {
            ...
            /************************************************
             * Define OutputStreams to write to file.
             ************************************************/
            ...
            /************************************************
             * Start reading the and writing the file.
             ************************************************/
